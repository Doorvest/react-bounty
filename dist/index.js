...
var ReactBounty = /*#__PURE__*/function (_PureComponent) {
  _inherits(ReactBounty, _PureComponent);

  var _super = _createSuper(ReactBounty);

  function ReactBounty() {
    var _this;

    _classCallCheck(this, ReactBounty);
